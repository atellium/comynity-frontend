...
export type BusinessListItem = {
  ...
  media: { thumbnail: string | null; cover_image?: string | null; gallery?: string[] };
  is_verified: boolean;
...
export type BusinessProduct = {
  ...
  price_type: "fixed" | "starts_from" | "ask" | "range" | string;
  price: string;
  max_price: string | null;
  mrp_price?: string | null;
  original_price?: string | null;
  categories?: BusinessProductCategory[] | null;
  variants?: ProductVariant[] | Record<string, string[]> | null;
  specifications?: Record<string, string | number | boolean | null> | Array<{ label: string; value: string }> | null;
  is_featured: boolean;
...
export type ProductDetailUploadImage = {
  id: string;
  upload: {
    id: string;
    url: string;
...
export type ProductDetail = Omit<BusinessProduct, "primary_image" | "variants" | "specifications" | "images"> & {
  type: string;
  description: string;
...
export type ProductDetailApiResponse = {
  result: (Omit<ProductDetail, "images" | "variants" | "specifications" | "custom_fields" | "business" | "original_price"> & {
    images: ProductDetailUploadImage[] | null;
    variants: Record<string, string[]> | ProductVariant[] | null;
    specifications: Array<{ label: string; value: string }> | ProductDetail["specifications"] | null;
    custom_fields?: ProductCustomField[] | null;
    mrp_price?: string | null;
    original_price?: string | null;
    business?: ProductDetail["business"];
  }) | null;
};
