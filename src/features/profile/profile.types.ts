...
export type BusinessUploadsResponse = {
  results: BusinessUpload[] | null;
};

export type BusinessUploadTicket = {
  id: string;
  object_key: string;
  upload_url: string;
  mime_type: string;
...
export type BusinessUploadTicketsResponse = {
  results: BusinessUploadTicket[] | null;
};
