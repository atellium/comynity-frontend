...
function OfferBusinessCard({
	...
	const businessHref = `/${encodeURIComponent(offer.business.slug)}`;
	const thumbnail = business?.media.cover_image || offer.business.cover_image || business?.media.thumbnail || offer.business.thumbnail;
